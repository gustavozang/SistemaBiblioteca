...
public class FornecedorVO {
   ...
   @Override
    public String toString() {
        return "FornecedorVO{" + "Codigo=" + codigo + ", nome=" + nome + ", endereco=" + endereco + "endereco_nr=" + endereco_nr + ", endereco_complemento=" + endereco_complemento + "bairro=" + bairro + "cidades=" + cidades + "cep=" + cep + "telefone=" + telefone + "celular=" + celular + '}';
    }
}//fecha classe
