...
public class EditoraVO {
    ...
    public String toString() {
        return "EditoraVO{" + "Codigo=" + codigo + ", nome=" + nome + ", endereco=" + endereco + "endereco_nr=" + endereco_nr + ", endereco_complemento=" + endereco_complemento + "bairro=" + bairro + "cidades=" + cidades + "cep=" + cep + "telefone=" + telefone + '}';
    }
}//fecha classe
