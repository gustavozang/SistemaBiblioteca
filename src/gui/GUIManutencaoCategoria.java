...
import servicos.CategoriaServicos;
import servicos.ServicosFactory;

public class GUIManutencaoCategoria extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form GUIManutencaoCategoria
     */
    public GUIManutencaoCategoria() {
        initComponents();
    ...
    private void preencherTabela() {
        try {
            ...
            //Buscando objeto CategoriaServicos     
            CategoriaServicos ps = ServicosFactory.getCategoriaServicos();

            /* Criando um ArrayList<CategoriaVO> vazio
             para receber o ArrayList com os dados */
            ArrayList<CategoriaVO> prod = new ArrayList<>();

            //Recebendo o ArrayList cheio em categorias
            prod = ps.buscarCategorias();
            ...
            /* Adicionando o modelo de tabela 
             com os dados na tabela categoria */
            jtableCategoria.setModel(dtm);
    ...
    private void excluir() {
        ...
        try {
            ...
            int i = jtableCategoria.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIManutencaoCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIManutencaoCategoria().setVisible(true);
            }
        });
    }
