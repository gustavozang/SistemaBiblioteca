 ...
 * @author Gustavo
 */
public class GUICadDepartamento extends javax.swing.JFrame {

    /**
     * Creates new form DepartamentoGUI
     */
    public GUICadDepartamento() {
			initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Cadastrar novo departamento"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DepartamentoVO departamentos = new DepartamentoVO();
        departamentos.setNome(TextField1.getText());
...
if ((TextField1.getText().isEmpty())) {
   JOptionPane.showMessageDialog(null, "Os campos não podem retornar vazios");
    ...
    // instanciando a classe DepartamentoDAO do pacote dao e criando seu objeto dao
    DepartamentoDAO dao = new DepartamentoDAO();
    try {
        dao.cadastrarDepartamento(departamentos);
    } catch (SQLException ex) {
        Logger.getLogger(GUICadDepartamento.class.getName()).log(Level.SEVERE, null, ex);
    }
    JOptionPane.showMessageDialog(null, "Departamento "+TextField1.getText()+" inserido com sucesso! ");
}
...
TextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUICadDepartamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUICadDepartamento().setVisible(true);
            }
        });
    }
