...
import servicos.DepartamentoServicos;
import servicos.ServicosFactory;

public class GUIManutencaoDepartamento extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form GUIManutencaoDepartamento
     */
    public GUIManutencaoDepartamento() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Manutenção Departamento");
    ...
    private void preencherTabela() {
        try {
            ...
            //Buscando objeto DepartamentoServicos     
            DepartamentoServicos ps = ServicosFactory.getDepartamentoServicos();

            /* Criando um ArrayList<DepartamentoVO> vazio
             para receber o ArrayList com os dados */
            ArrayList<DepartamentoVO> prod = new ArrayList<>();

            //Recebendo o ArrayList cheio em departamentos
            prod = ps.buscarDepartamentos();
            ...
            /* Adicionando o modelo de tabela 
             com os dados na tabela departamento */
            jtableDepartamento.setModel(dtm);
    ...
    private void excluir() {
        ...
        try {
            ...
            int i = jtableDepartamento.getSelectedRow();

            DepartamentoDAO p = new DepartamentoDAO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIManutencaoDepartamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIManutencaoDepartamento().setVisible(true);
            }
        });
    }
