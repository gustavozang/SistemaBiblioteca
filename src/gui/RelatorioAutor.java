 ...
 */
package gui;
import dao.AutorRelatorioDAO;
import net.sf.jasperreports.view.JasperViewer;
/**
 *
 * @author gustavoz
 */
public class RelatorioAutor extends javax.swing.JFrame {

    /**
     * Creates new form RelatorioAutor
     */
    public RelatorioAutor() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AutorRelatorioDAO prd = new AutorRelatorioDAO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioAutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioAutor().setVisible(true);
            }
        });
    }
