...
import servicos.CidadeServicos;
import servicos.ServicosFactory;

public class GUIManutencaoCidade extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form GUIManutencaoCidade
     */
    public GUIManutencaoCidade() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jtUF = new javax.swing.JFormattedTextField();
        ...
        jPanel1.add(jtCidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(89, 49, 208, -1));

        jLabel1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel1.setText("Alteração de CIdade");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 120, -1));

        try {
            jtUF.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("**")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        jPanel1.add(jtUF, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 60, -1));
    ...
    private void preencherTabela() {
        try {
            ...
            //Buscando objeto CidadeServicos     
            CidadeServicos ps = ServicosFactory.getCidadeServicos();

            /* Criando um ArrayList<CidadeVO> vazio
             para receber o ArrayList com os dados */
            ArrayList<CidadeVO> prod = new ArrayList<>();

            //Recebendo o ArrayList cheio em cidadees
            prod = ps.buscarCidades();

            for (int i = 0; i < prod.size(); i++) {
                dtm.addRow(new String[]{
                    String.valueOf(prod.get(i).getCodigo()),
                    String.valueOf(prod.get(i).getCidade()),
                    String.valueOf(prod.get(i).getUf()),
                });
            }//fecha for
            
            /* Adicionando o modelo de tabela 
             com os dados na tabela cidade */
            jtableCidade.setModel(dtm);
    ...
    private void excluir() {
        ...
        try {
            ...
            //Recebendo o ArrayList cheio em cidades
            prod = ps.buscarCidades();

            int i = jtableCidade.getSelectedRow();

            CidadeDAO p = new CidadeDAO();
    ...
    private void informacoes(){
         try {
            ...
            jtCidade.setText(prod.get(i).getCidade());
            jtUF.setText(prod.get(i).getUf());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIManutencaoCidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIManutencaoCidade().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField jtUF;
