...
public class GUIManutencaoFuncionario extends javax.swing.JInternalFrame {
    ...
    DefaultTableModel dtm = new DefaultTableModel(
            new Object[][]{},
            new Object[]{"Código", "Nome", "Departamento"});
    ...
    private void preencherTabela() {
        try {
            ...
            //Buscando objeto FuncionarioServicos     
            ...
            //Recebendo o ArrayList cheio em funcionarios
            prod = ps.buscarFuncionarios();

            for (int i = 0; i < prod.size(); i++) {
                dtm.addRow(new String[]{
                    String.valueOf(prod.get(i).getCodigo()),
                    String.valueOf(prod.get(i).getNome()),
                    String.valueOf(prod.get(i).getNome_departamento()),
                });
            }//fecha for
    ...
    private void alterar() {
        try {
            ...
            jtValor.setText(String.valueOf(prod.get(i).getDepartamento()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIManutencaoFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
